...
<head>
    ...
    <link rel="apple-touch-icon-precomposed apple-touch-icon"
        href=" {{ asset('assets/storage/icons/apple-touch-icon.png') }} ">

    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBJQ58JnvpmUStRpQFABxBr1I0gxoH2j4g&libraries=places">
    </script>
...
<body class="hide-content">
    ...
    <div class="container container-index">
        <div id="card_registrarse" class="card card-sesion">
            ...
            <form action="{{ route('app.code') }} " method="post" class='form-index'>
                @csrf
                ...
                <div class="col-md-12 form-index-child">
                    <input class="input-option-1" type="password" id="password" name="password"
                ...
                <div class="col-md-12 form-index-child">
                    <input class="input-option-1" type="password" id="repeat_password" name="repeat_password"
                ...
                <div class="col-md-12 form-index-child">
                    <button type="submit" id="registerButton"
                        class="button-option-1 m-2">
                        <i class="fas fa-sign-in-alt fa-2x m-2"></i>
                    </button>
                </div>
                <div class="col-md-12 form-index-child">
                    <span class='span-option-1'>Al Continuar Acepta Nuestros <a href="#">Términos y Condiciones</a></span>
                </div>
            </form>
            ...
            <div class="form-index-child">
                <a href=" {{ route('app.index') }} " id="log_in_option" class="anchor-option-1">Iniciar Sesión</a>
            </div>
