<a class="sidebar-item" href=" {{ route('static.location.index') }}"><i class="fas fa-map-marker-alt"></i> Mis
    direcciones</a>
...
<a class="sidebar-item" href=" {{ route('app.logout') }} " id="cerrar_sesion"><i class="fas fa-sign-out-alt"></i>
    Salir</a>
