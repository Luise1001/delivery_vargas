<div class="slider">
    <div class="type-order-title">Descontinuados</div>
    <div id="disabled" class="products">

        @if ($disabled_products->count() > 0)
            @foreach ($disabled_products as $product)
                <div class="item-grid">
                    ...
                    <div class="button-grid">
                        ...
                        <form hidden action="{{route('commerce.product.delete')}}" method="post">
                            @csrf
                            @method('DELETE')
