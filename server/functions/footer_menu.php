...
if(isset($_SESSION['admin']))
{
  ...
  if($nivel === '0')
  {
    include_once 'users_menu/smartphone/footer/clientes.php';
     echo $menu_clientes;
  }

 if($nivel === '1')
 {
   include_once 'users_menu/smartphone/footer/administradores.php';
   echo $menu_admin;
 }

 if($nivel === '2')
 {
  include_once 'users_menu/smartphone/footer/conductores.php';
  echo $menu_conductores;
 }

 if($nivel === '3')
 {
   include_once 'users_menu/smartphone/footer/comercios.php';
   echo $menu_comercio;
 }
